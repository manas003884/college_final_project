...
beta = 0.18;
%input image
Input_image_1 = imread('F:\encryption\Digital-image-watermarking-using-DWT-and-chaotic-maps\002L_1.png');
dim=1024;
...
%watermark images
watermark_image1 = imread('F:\encryption\Digital-image-watermarking-using-DWT-and-chaotic-maps\right.jpg');
watermark_image_1p=preprossesing(watermark_image1,p(1,1));
watermark_image2 = imread('F:\encryption\Digital-image-watermarking-using-DWT-and-chaotic-maps\left.jpg');
...
I_1=im2uint8(I);
imwrite(I_1, 'F:\encryption\Digital-image-watermarking-using-DWT-and-chaotic-maps\watermarked_image.png', 'png');
%enc
enc=encrypt();
%decr
decr=decrypt();
